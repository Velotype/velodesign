// deno:https://jsr.io/@velotype/velotype/0.0.19/src/tsx/tsx-core.ts
...
var styleSectionMounted = /* @__PURE__ */ new Map();
...
function setStylesheet(sheetText, sheetKey, resetSheet = false) {
...
// deno:https://jsr.io/@velotype/velotype/0.0.19/src/jsx-runtime/jsx-runtime.ts
...
`, "vtd/Button");
  ...
  render(attrs, children) {
    ...
    return /* @__PURE__ */ jsxs("button", {
      ...
      children: [
        /* @__PURE__ */ jsx("span", {
          style: attrs.loadingIcon && this.isLoading ? {
            color: "transparent"
          } : {},
          children
        }),
        attrs.loadingIcon && /* @__PURE__ */ jsx("span", {
          style: spinnerStyle,
          children: /* @__PURE__ */ jsx(ButtonThemeOptions.spinner, {})
        }) || null
      ]
    });
  }
...
// ../src/utilities.ts
var consoleLog2 = console.log;
var setAttributeHelper2 = function(element, qualifiedName, value) {
  element.setAttribute(qualifiedName, value);
};
var svgNamespace = "http://www.w3.org/2000/svg";
var createElementNSHelper = function(qualifiedName) {
...
var I = function(attrs) {
  ...
  if (icon) {
    const svg = createElementNSHelper("svg");
    setAttributeHelper2(svg, "xmlns", svgNamespace);
    setAttributeHelper2(svg, "class", "vtd-icon");
    setAttributeHelper2(svg, "role", "img");
    setAttributeHelper2(svg, "viewBox", `0 0 ${icon.w} ${icon.h}`);
    if (attrs.style) {
      setAttrsOnElement(svg, {
        style: attrs.style
      });
    }
    const path = createElementNSHelper("path");
    setAttributeHelper2(path, "fill", "currentcolor");
    setAttributeHelper2(path, "d", icon.d);
    svg.appendChild(path);
    return svg;
  }
  return null;
};
var iconStylesheetSet = false;
...
// ../src/license.ts
var licenses = /* @__PURE__ */ new Map();
var licenseLog = /* @__PURE__ */ new Set();
var initialSetLogged = false;
var addLicense = (key, text) => {
  if (!licenses.has(key)) {
...
// ../src/theme.ts
var defaultTextLightColor = "#050505";
var defaultBackgroundLightColor = "#fafafa";
var defaultPrimaryLightColor = "#66b2ff";
var defaultSecondaryLightColor = "#c6ff9e";
var defaultWarningLightColor = "#ffd666";
var defaultAccentLightColor = "#ff6666";
var defaultTextDarkColor = "#fafafa";
var defaultBackgroundDarkColor = "#202020";
var defaultPrimaryDarkColor = "#004c99";
var defaultSecondaryDarkColor = "#286100";
var defaultWarningDarkColor = "#997000";
var defaultAccentDarkColor = "#990000";
var colorMix = ":color-mix(in hsl,";
var middleSpread = [
  -6,
  -4,
  -2,
...
var middleColorSpread = (cssColorPrefix, color1, color2, color3) => {
...
var colorGradient = (cssColorPrefix, color1, color2) => {
  return gradient.map((e) => `--${cssColorPrefix}-${e}${colorMix}${color1} ${10 - e}0%,${color2} ${e}0%)`).join(";") + `;--${cssColorPrefix}:${color1};`;
};
var setTheme = function(theme) {
  setAttributeHelper2(document.getElementsByTagName("html")[0], "data-theme", theme);
};
var localThemeKey = "vtd-preferredtheme";
var light = "light";
var dark = "dark";
var defaultScheme = "default";
var colorScheme = light;
var Theme = {
  getColorScheme: function() {
    return colorScheme;
  },
  setColorScheme: function(newScheme) {
  ...
  addVelodesignStyles(options, includeCSSReset = true) {
    if (includeCSSReset) {
...
`, "vtd/Modal");
  ...
  constructor(attrs, children) {
    ...
    this.confirmButton = /* @__PURE__ */ jsx(Button, {
      type: "primary",
      ...
      children: attrs.confirmButtonChildren
    });
    this.dialog = /* @__PURE__ */ jsxs("dialog", {
      class: "vtd-modal",
      closedby: "any",
      children: [
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Button, {
              ...
              children: /* @__PURE__ */ jsx(ModalThemeOptions.closeSymbol, {})
            })
          ]
        }),
        /* @__PURE__ */ jsx("hr", {
          class: "vtd-modal-separator"
        }),
        /* @__PURE__ */ jsx("div", {
          class: "vtd-modal-inner",
          children
        }),
        /* @__PURE__ */ jsx("hr", {
          class: "vtd-modal-separator"
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsx(Button, {
              ...
              children: attrs.cancelButtonChildren
            }),
            this.confirmButton
          ]
        })
...
var ButtonModal = class extends Component {
  modal;
  constructor(attrs, children) {
    super(attrs, children);
    this.modal = /* @__PURE__ */ jsx(Modal, {
      ...attrs.modalAttrs,
      children
    });
  }
  render(attrs) {
    return /* @__PURE__ */ jsxs("span", {
      ...
      children: [
        this.modal,
        /* @__PURE__ */ jsx(Button, {
          type: attrs.openButtonType || "secondary",
          onClick: () => {
            this.modal.showModal();
          },
          children: attrs.openButtonText
        })
      ]
    });
  }
...
// test_modules/module-page.tsx
var NavSchemeSelector = class extends Component {
  render() {
    return /* @__PURE__ */ jsx("div", {
      ...
      children: /* @__PURE__ */ jsxs(Button, {
        ...
        children: [
          "Dark mode:",
          Theme.getColorScheme() == "light" ? "off" : "on"
        ]
      })
    });
  }
};
var TestModulePage = class extends Component {
  render(_attrs, children) {
    return /* @__PURE__ */ jsxs("div", {
      children: [
        ...
        /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsx(NavSchemeSelector, {})
        }),
        /* @__PURE__ */ jsx("div", {
          children
        })
...
var ModalGallery = class extends Component {
  buttonClicked = new RenderBasic(false);
  render() {
    const modal = /* @__PURE__ */ jsx(Modal, {
      title: "Test base modal",
      confirmButtonChildren: "confirm",
      cancelButtonChildren: "cancel",
      children: "inner modal content"
    });
    return /* @__PURE__ */ jsxs("div", {
      children: [
        modal,
        /* @__PURE__ */ jsx(Button, {
          ...
          children: "Open base modal"
        }),
        /* @__PURE__ */ jsx(ButtonModal, {
          modalAttrs: {
            title: "Test button modal",
          ...
          openButtonText: "Open button modal",
          children: "inner modal content"
        })
      ]
    });
...
if (mainPage) {
  replaceElementWithRoot(/* @__PURE__ */ jsx(TestModulePage, {
    children: /* @__PURE__ */ jsx(ModalGallery, {})
  }), mainPage);
}
