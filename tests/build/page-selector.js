...
var consoleError2 = console.error;
...
var History = {
  ...
  loadNewPageLocation: function(newLocation) {
...
// ../src/page-selector.tsx
var PageSelector = class extends Component {
  ...
  render(attrs) {
    const page = attrs.pages.find(function(page2) {
      if (globalThis.location.pathname == page2.basename) {
        return true;
      }
      return false;
    });
    if (page) {
      return /* @__PURE__ */ jsx(page.page, {});
    } else {
      return /* @__PURE__ */ jsx(attrs.notFoundPage, {});
    }
  }
};
...
// test_modules/page-selector.tsx
function pageSelectorPage(pagename) {
  return function() {
    return /* @__PURE__ */ jsxs("div", {
      children: [
        /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsx(Link, {
            to: "/page-selector",
            children: "link to page none"
          })
        }),
        /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsx(Link, {
            to: "/page-selector/one",
            children: "link to page one"
          })
        }),
        /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsx(Link, {
            to: "/page-selector/two",
            children: "link to page two"
          })
        }),
        /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsx(Link, {
            to: "/page-selector/three",
            children: "link to page three"
          })
        })
      ]
    });
...
var PageSelectorGallery = class extends Component {
  buttonClicked = new RenderBasic(false);
  render() {
    return /* @__PURE__ */ jsx("div", {
      children: /* @__PURE__ */ jsx(PageSelector, {
        pages: [
          {
            basename: "/page-selector",
            page: pageSelectorPage("none")
          },
          {
            basename: "/page-selector/one",
            page: pageSelectorPage("one")
          },
          {
            basename: "/page-selector/two",
            page: pageSelectorPage("two")
          },
          {
            basename: "/page-selector/three",
            page: pageSelectorPage("three")
          }
        ],
...
if (mainPage) {
  replaceElementWithRoot(/* @__PURE__ */ jsx(TestModulePage, {
    children: /* @__PURE__ */ jsx(PageSelectorGallery, {})
  }), mainPage);
}
