...
class NavLinkGallery extends Component<EmptyAttrs> {
    override render() {
        return <div style={{marginTop:"10px", display: "flex", gap: "12px"}}>
            <NavLink id="navlink-home" to="/nav-link" spa>Home (exact, active here)</NavLink>
            <NavLink to="/nav-link/other" spa>Other (inactive)</NavLink>
            <NavLink to="/nav-link" exact={false} spa>Home (prefix match)</NavLink>
        </div>
    }
}
